    ...
    <div class="row mt-3" v-else>
        <div class="col mb-3" v-for="(product, index) in search_products" :key="index">
            <div class="card" style="width: 19rem;">
                <img :src="product.image" class="card-img-top mx-auto" :alt="product.title" style="width: 12rem; height: 12rem;" />
                <div class="card-body">
...
const search_products = computed(() => product_store.searh_products)
