<template>
    <div class="d-flex justify-content-center mt-3" v-if="!load_product">
   ...
   <div class="row mt-5" v-else>
    <div class="col-md-6">
        ...
        <div class="d-flex mt-3">
            ...
            <button class="btn btn-primary" @click="cart_store.add_cart_detail(product.id, product.price, quantity)">เพิ่มสินค้า</button>    </div>
        </div>
   </div>
</template>
